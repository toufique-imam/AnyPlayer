...
public class Settings {
    ...
    public int getThemeId() {
        ...
        if (themeNow == 0) return R.style.Theme_AnyPlayer_NoActionBar;
        else if (themeNow == 1) return R.style.Theme_AnyPlayer_Day;
        else return R.style.Theme_AnyPlayer_Night;
    }
